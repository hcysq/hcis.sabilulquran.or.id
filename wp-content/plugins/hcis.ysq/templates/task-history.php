...
$readonly = !empty($context['readonly']);
$viewerNip = isset($context['viewer_nip']) ? (string) $context['viewer_nip'] : '';
        ...
        <table class="hcisysq-history-table">
          <tbody>
            <tr>
              ...
              <td><?php echo $title !== '' ? esc_html($title) : '&mdash;'; ?></td>
            </tr>
            <tr>
              <th scope="row"><?php esc_html_e('Keterangan', 'hcisysq'); ?></th>
              <td><?php echo $description !== '' ? wp_kses_post($description) : '&mdash;'; ?></td>
            </tr>
            <tr>
              <th scope="row"><?php esc_html_e('Batas waktu', 'hcisysq'); ?></th>
              <td><?php echo $deadlineDisplay !== '' ? esc_html($deadlineDisplay) : ($deadline !== '' ? esc_html($deadline) : '&mdash;'); ?></td>
            </tr>
            <tr>
              <th scope="row"><?php esc_html_e('Teks tautan', 'hcisysq'); ?></th>
              <td><?php echo $linkLabel !== '' ? esc_html($linkLabel) : '&mdash;'; ?></td>
            </tr>
            <tr>
              <th scope="row"><?php esc_html_e('URL tautan', 'hcisysq'); ?></th>
              <td>
                <?php if ($linkUrl !== '') : ?>
                  <a class="btn-link" href="<?php echo esc_url($linkUrl); ?>" target="_blank" rel="noopener noreferrer"><?php echo esc_html($linkUrl); ?></a>
                <?php else : ?>
                  &mdash;
                <?php endif; ?>
              </td>
          ...
          <table class="hcisysq-history-assignment-table">
            ...
            <tbody>
              <?php foreach ($assignments as $index => $row) :
                ...
                $isViewer = $viewerNip !== '' && isset($row['nip']) && (string) $row['nip'] === $viewerNip;
              ?>
                <tr<?php echo $isViewer ? ' class="is-viewer"' : ''; ?>>
