...
add_action('wp_ajax_nopriv_hcisysq_admin_create_task', ['HCISYSQ\\Api', 'admin_create_task']);
add_action('wp_ajax_hcisysq_admin_update_task', ['HCISYSQ\\Api', 'admin_update_task']);
add_action('wp_ajax_nopriv_hcisysq_admin_update_task', ['HCISYSQ\\Api', 'admin_update_task']);
add_action('wp_ajax_hcisysq_admin_delete_task', ['HCISYSQ\\Api', 'admin_delete_task']);
add_action('wp_ajax_nopriv_hcisysq_admin_delete_task', ['HCISYSQ\\Api', 'admin_delete_task']);
add_action('wp_ajax_hcisysq_admin_set_task_status', ['HCISYSQ\\Api', 'admin_set_task_status']);
add_action('wp_ajax_nopriv_hcisysq_admin_set_task_status', ['HCISYSQ\\Api', 'admin_set_task_status']);
add_action('wp_ajax_hcisysq_admin_update_assignment', ['HCISYSQ\\Api', 'admin_update_assignment']);
add_action('wp_ajax_nopriv_hcisysq_admin_update_assignment', ['HCISYSQ\\Api', 'admin_update_assignment']);
